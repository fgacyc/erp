...
import { Form, Input, Button, Message, Cascader, Typography } from '@arco-design/web-react';
                ...
                onSubmit={(v) => {
                    ...
                    postReq('/interviewer', registration_data).then((res) => {
                        if (res.status) {
                            ...
                            alert(`Your CYC ID is ${res.data.CYC_ID}. Your password is ${res.data.password}. Please take a screenshot of your credentials and keep them safe.`)
                        }
                    });
                }}
            >
                <FormItem label='Full Name' field='full_name' rules={[{ required: true, message: 'full name 是必填项' }]}>
                    <Input placeholder='please enter your full name' />
                </FormItem>
                <FormItem label='Username' field='username' rules={[{ required: true, message: 'username 是必填项' }]}>
