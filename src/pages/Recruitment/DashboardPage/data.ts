...
export function getInterviewRatio(usersData: Recruiter[]) {
	let notScheduled = 0;
	let scheduled = 0;
	let interviewed = 0;
...
export function getEvaluationRatio(usersData: Recruiter[]) {
	let notEvaluation = 0;
	let nextTime = 0;
	let kiv = 0;
	let pass = 0;
...
export function getRecruiterRatio(usersData: Recruiter[]) {
	let passed = 0;
	let rejected = 0;
	let KIV = 0;
