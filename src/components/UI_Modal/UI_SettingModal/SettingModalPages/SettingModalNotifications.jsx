...
export  default function SettingModalNotifications(){
    return(
        <div>
            ...
            <div  style={{marginBottom:40}}>
                ...
                <div className="display-flex-space-between"  style={{marginBottom:10}}>
                    <div>
                        <div >Notifications</div>
                        <div className="setting-desc-text-grey" >Receive emails when you get notifications.</div>
                    </div>
                    <div style={{width:140, textAlign:"right"}} >
                        <Switch  checked={true} />
                    </div>
                ...
                <div className="display-flex-space-between"  style={{marginBottom:10}}>
                    <div>
                        <div >Messages</div>
                        <div className="setting-desc-text-grey" >Receive emails when you get messages.</div>
                    </div>
                    <div style={{width:140, textAlign:"right"}} >
                        <Switch  checked={true} />
                    </div>
                ...
                <div className="display-flex-space-between"  style={{marginBottom:10}}>
                    <div>
                        <div >Tasks</div>
                        <div className="setting-desc-text-grey" >Receive emails when you get tasks.</div>
                    </div>
                    <div style={{width:140, textAlign:"right"}} >
                        <Switch checked={true} />
                    </div>
