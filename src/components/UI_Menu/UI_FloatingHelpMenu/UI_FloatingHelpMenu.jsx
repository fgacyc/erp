...
export default function UI_FloatingHelpMenu() {
    ...
    return (
        <>
            ...
            <GithubReportModal type="bug" visible={bugModalVisible} setVisible={setBugModalVisible} />
            <GithubReportModal type="enhancement" visible={ideaModalVisible} setVisible={setIdeaModalVisible} />
        </>
    );
}
